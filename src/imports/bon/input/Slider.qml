...
T.Slider {
    ...
    property color _backgroundOffColor: root.pressed ? B.Theme.palette.background_2 : B.Theme.palette.background_1
    ...
    handle: Rectangle {
        ...
        Rectangle {
            ...
            radius: width / 2
            color: root.pressed || root.hovered || !root.enabled ? B.Theme.palette.highlight_1 : B.Theme.palette.highlight
