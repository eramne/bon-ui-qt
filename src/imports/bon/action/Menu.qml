            ...
            if (actions[i] instanceof MenuItem) {
                ...
                tmpModel.push({
                                  ...
                                  leading: action.checkable && action.checked ?
                                               B.ListLeading.icon({name: "check"}) :
                                               B.ListLeading.icon({name: action.icon.name ? action.icon.name : "blank"}),
                                  trailing: shortcutString ? B.ListTrailing.caption({text: shortcutString}) : undefined,
                ...
                tmpModel.push({
                                  ...
                                  leading: B.ListLeading.icon({name: "blank"}),
                                  trailing: B.ListTrailing.icon({name: "chevron_right"}),
